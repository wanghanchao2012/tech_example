package com.example.common.example.RSA;


import com.example.common.util.CoderUtil;
...
public class RSADemo2 {
    ...
    public static PublicKey getPublicKey(String publicKey) throws Exception {
        byte[] keyBytes = CoderUtil.decodeBase64(publicKey);
    ...
    public static PrivateKey getPrivateKey(String privateKey) throws Exception {
        byte[] keyBytes = CoderUtil.decodeBase64(privateKey);
